...
const theme: DefaultTheme = {
	...
	fonts: {
		headline_oneline_001: fontStyleGenerator({ weight: 700, size: 48, height: 50, spacing: -1 }),
		headline_multiline_001: fontStyleGenerator({ weight: 700, size: 48, height: 64, spacing: -1 }),
		...
		body_oneline_004: fontStyleGenerator({ weight: 400, size: 14, height: 16, spacing: -0.4 }),
		body_oneline_005: fontStyleGenerator({ weight: 400, size: 13, height: 15, spacing: -0.4 }),
		...
		tab_001: fontStyleGenerator({ weight: 600, size: 15, height: 17, spacing: -0.4 }),
